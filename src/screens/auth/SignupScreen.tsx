...
export default function SignupScreen({ navigation }: Props) {
  ...
  const handleSignup = async () => {
    ...
    try {
      ...
      if (!success) {
        setErrorMsg("Failed to create an account. Email might be in use.");
      }
    } catch (err: any) {
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.header}>
            ...
            <Text variant="bold" size="xxl" color="charcoal" style={styles.titleText}>
              Create Account
            </Text>
            <Text variant="regular" size="sm" color="textGrey" style={styles.subtitle}>
              Join Zaika to discover delicious food near you
            </Text>
          </View>
          ...
          <View style={styles.form}>
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.inputWrapper}>
                <Ionicons name="person-outline" size={20} color={colors.mediumGrey} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
            ...
            <View style={styles.inputContainer}>
              ...
              <View style={styles.inputWrapper}>
                <Ionicons name="call-outline" size={20} color={colors.mediumGrey} style={styles.inputIcon} />
                <TextInput
                  style={styles.input}
